# Task: Build a Simple Book Catalog Application using React ,Redux & Typescript (Frontend Category)
...
- 50 Marks  ( Till 18Th July, Tuesday 11.59 PM )
 ...
 `** In order for your Task to be evaluated, it is essential to have a minimum of 20 meaningful commits. Please note that unnecessary commits will not be considered as part of the evaluation process.**`
